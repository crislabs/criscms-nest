...
import { PetProductService } from 'src/products/categories/pet/category.service';
// import { PetProductService } from 'src/products/categories/pet/pet/category.service';
...
export class PetPage11Resolver {
  ...
  @Query(() => [PetPage11], { name: 'petGetPages11ByParentIdByPagination' })
  ...
  getProduct(@Parent() { _id, data }: PetPage11) {
  ...
  getPages(@Parent() { _id, data }: PetPage11) {
