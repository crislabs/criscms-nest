...
export class PortfolioPage10Resolver {
  ...
  @Query(() => [PortfolioPage10], { name: 'portfolioGetPages10ByParentIdByPagination' })
  ...
  getProduct(@Parent() { _id, data }: PortfolioPage10) {
  ...
  getPages(@Parent() { _id, data }: PortfolioPage10) {
